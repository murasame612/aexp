...
func TestDeriveRunEventSummary(t *testing.T) {
	lines := []executor.LogLine{
		...
		{LineNo: 3, Content: `{"type":"metric","split":"val","name":"mAP50-95(B)","value":0.48,"epoch":7}`},
		{LineNo: 4, Content: `{"type":"metric","split":"val","name":"mAP50-95(B)","value":0.55,"epoch":8}`},
	...
	metric := summary.Metrics["val/mAP50-95(B)"]
