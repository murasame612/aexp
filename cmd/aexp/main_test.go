...
func TestAgentCardUsesProjectJournalForResearchReasoning(t *testing.T) {
	...
	for _, want := range []string{
		...
		"Every new or touched Result requires the incoming Experiment Design --next_step--> Result spine",
		"must not emit an outgoing semantic edge back to a hypothesis, design, or another result",
		"projected_research.unassigned",
